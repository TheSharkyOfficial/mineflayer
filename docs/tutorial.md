...
You can create your own event from chat using [`bot.addChatPattern()`](http://prismarinejs.github.io/mineflayer/#/api?id=botaddChatpatternpattern-chattype-description) method. Useful for Bukkit servers where the chat format changes a lot.
[`bot.addChatPattern()`](http://prismarinejs.github.io/mineflayer/#/api?id=botaddChatpatternpattern-chattype-description) method takes three arguments :
